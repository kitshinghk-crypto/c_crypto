...
int main(){
    ...
    //01 00 00 01 b8 63 36 33 77 e4 1e 86 46 8d eb 0a b4 a8 ed 68 3f 6a 13 4e 47 e0 14 c7 
    //00 45 4e 81 e9 53 58 a5 69 80 8a a3 8f 2a 72 a6 23 59 91 5a 9f 8a 04 ca 68
    uint8_t m4[53]={0x02,0x00,0x00,0x01,0xb8,0x09,0x96,0xa3,0x82,0x5a,0x45,0x6d,0xb3,0xc5,0xae,0x7c,0x00,0x58,0xe6,0xf9,0xb5,0xf4,0x38,0x40,0x74,0xdd,0xfe,0x37,0xb4,0xac,0x68,0xe2,0xc9,0x8b,0xdb,0x54,0xc5,0x31,0x84,0x43,0xaa,0xf8,0xc6,0x6f,0x2b,0x81,0xe4,0x14,0xde,0xe9,0x55,0x3f,0x7c};
    uint8_t hash3[32]={0};
    sha256_8u_hash(hash3, m4, 53*8);
    printf("hash:\n");
    print_arr(hash3, 32);
}