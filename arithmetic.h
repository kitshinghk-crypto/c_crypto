...
extern void divide(uint16_t*, uint16_t*, const uint16_t*, const uint16_t*, uint8_t, uint8_t);
...
extern void reduce(uint16_t*, uint8_t, const uint16_t*);
...
extern void print_hex(const uint16_t *, uint8_t);
extern void print_bin(const uint16_t *, uint8_t);
...
extern void mont_exp(uint8_t* x,const uint8_t* e,const uint8_t* p,size_t rlen);
#endif